if { [namespace current] != {::64F92246} } { error {This script [file tail [info script]] should not be sourced directly}; }
###################################################################

# Created by write_script -format dctcl for scenario [mode_norm.slow.RCmax] on \
Wed Sep  6 21:07:18 2023
...
set_operating_conditions max -library                                          \
sky130_fd_sc_hs__ss_n40C_1v60_ccsnoise.db:sky130_fd_sc_hs
