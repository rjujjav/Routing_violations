...
# Created by write_sdc for scenario [mode_norm.slow.RCmax] on Wed Sep 6 15:59:14 2023

###################################################################
set sdc_version 2.1

set_units -time ns -resistance kOhm -capacitance pF -voltage V -current mA
set_operating_conditions max -library sky130_fd_sc_hs__ss_n40C_1v60_ccsnoise.db:sky130_fd_sc_hs
set_max_area 0
