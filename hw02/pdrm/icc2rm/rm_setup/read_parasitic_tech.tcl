...
set tluplus_file($parasitic1)           "${TECH_HOME}/google/star_rcxt/sky130/sky130_RCmax.tluplus" ;# TLU+ files to read for parasitic 1
set layer_map_file($parasitic1)         "${TECH_HOME}/google/star_rcxt/sky130/layer.map" ;# layer mapping file between ITF and tech for parasitic 1

set parasitic2				"RCmin" ;# name of parasitic tech model 2
set tluplus_file($parasitic2)           "${TECH_HOME}/google/star_rcxt/sky130/sky130_RCmin.tluplus" ;# TLU+ files to read for parasitic 2
set layer_map_file($parasitic2)         "${TECH_HOME}/google/star_rcxt/sky130/layer.map" ;# layer mapping file between ITF and tech for parasitic 2
